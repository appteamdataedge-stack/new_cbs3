...
/**
 * Test for native query methods in GLMovementAccrualRepository
 * Verifies the fix for Batch Job 5 Hibernate duplicate row issue
 */
@DataJpaTest
@ActiveProfiles("test")
@DisplayName("GL Movement Accrual Repository Native Query Tests")
class GLMovementAccrualRepositoryNativeQueryTest {
    ...
    void testFindDrCrSummationNative_NoData() {
        ...
        // When
        List<Object[]> results = glMovementAccrualRepository.findDrCrSummationNative(
