-- Populate txn_hist_acct with CORRECT running balance calculation
USE moneymarketdb;
...
BEGIN
    ...
    read_loop: LOOP
        ...
        IF v_account_no != v_current_account THEN
            ...
            END IF;
        ELSE
            -- Same account, get last inserted balance
...
-- Execute
SELECT 'Starting population with correct running balance...' AS Status;
...
SELECT '========================================' AS Message;
SELECT 'Sample Records for Account 100000071001' AS Message;
SELECT '========================================' AS Message;
...
SELECT '========================================' AS Message;
SELECT 'All Sample Records' AS Message;
SELECT '========================================' AS Message;
